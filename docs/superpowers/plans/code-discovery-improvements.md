...
Branch: feat/code-discovery-improvements (from feat/vendx-architecture-gamma)
Target PR: → main
...
Port the following sections from the earlier code-discovery session's CLAUDE.md, adapted to
